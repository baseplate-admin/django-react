...
export default function HeroMedium() {
    ...
    function validateUrl() {
        let urlTrueOrFalse = validator.isURL(long)
        if (urlTrueOrFalse) {
            postData()
            setHiddenLong(long)
            setLong("")
    ...
    return (
        <>
            <Hero />
            <input id='hidden-long' type="hidden" value={hiddenLong}/>
                ...
                <div className="hero-body" style={{ textAlign: 'center' }}>
                    <div className="container">
                        ...
                        <div className="control has-icons-left" style={{ textAlign: 'center' }}>
                            ...
                            <input id='long-url' onChange={handleChange} required value={long} className="input is-info" type="text" placeholder="Long Version Url"
                                style={{
                                    width: 400
                                }} />
